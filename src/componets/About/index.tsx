...
import "./About.scss";
import AboutScheme from "./components/Scheme";
import AboutExpand from "./components/Expand";
...
const About: FC<AboutProps> = ({ percent }) => {
  return (
    <div className="page__about about">
      <div className="about__container container-more">
        <div className="about__title  title-more">
          <span>Почему</span> <span>digital-агентство</span>{" "}
          <GradientText text="Family ..." />
        </div>
        <AboutScheme percent={percent} />
        <div className="about__btns">
          <Btn
            text="Как считается NPS ?"
            svg={
              <svg
                width="16"
                height="16"
